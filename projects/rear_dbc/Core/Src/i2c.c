...
#define REG_COMBINED_CONFIG         0x20
#define REG_GYRO_ACCEL_FILT         0x28
#define REG_INT_CONFIG              0x06
#define REG_INT_SOURCE0             0x65
#define INT1_OPEN_DRAIN_ACTIVE_LOW  0x04

/* IMU Configuration Bitmasks */
#define PWR_LN_MODE                 0x0F
#define CONFIG_16G_2000DPS_1KHZ     0x4F
#define FILT_BW_25HZ                0x33
#define INT1_PUSH_PULL_ACTIVE_HIGH  0x02
#define INT_SOURCE_DRDY             0x08
/* USER CODE END 0 */
