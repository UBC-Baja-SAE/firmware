...
| Modified     | 2026-06-10 1:20:17 PM          |
| Modified By  |                                |
...
| ------------ | ------------------------------------------------------------- |
| COB_ID       | $NODEID+0x180                                                 |
| Transmission | type=254; inhibit-time=100; event-timer=10                    |
|   0x20010120 | imu (accel_x)                                                 |
|   0x20010420 | imu (gyro_x)                                                  |
...
| COB_ID       | $NODEID+0x280                                                 |
| Transmission | type=254; inhibit-time=100; event-timer=10                    |
|   0x20010220 | imu (accel_y)                                                 |
|   0x20010520 | imu (gyro_y)                                                  |
...
| COB_ID       | $NODEID+0x380                                                 |
| Transmission | type=254; inhibit-time=100; event-timer=10                    |
|   0x20010320 | imu (accel_z)                                                 |
|   0x20010620 | imu (gyro_z)                                                  |
...
| COB_ID       | $NODEID+0x480                                                 |
| Transmission | type=254; inhibit-time=100; event-timer=10                    |
|   0x20000020 | linear potentiometer                                          |
...
| 0x01 | COB-ID used by RPDO   | UNSIGNED32 | rw  | no  | no   | $NODEID+0x80000240|
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x05          |
| 0x01 | COB-ID used by RPDO   | UNSIGNED32 | rw  | no  | no   | $NODEID+0x80000340|
| 0x02 | Transmission type     | UNSIGNED8  | rw  | no  | no   | 254           |
| 0x05 | Event timer           | UNSIGNED16 | rw  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x05          |
| 0x01 | COB-ID used by RPDO   | UNSIGNED32 | rw  | no  | no   | $NODEID+0x80000440|
| 0x02 | Transmission type     | UNSIGNED8  | rw  | no  | no   | 254           |
| 0x05 | Event timer           | UNSIGNED16 | rw  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x05          |
| 0x01 | COB-ID used by RPDO   | UNSIGNED32 | rw  | no  | no   | $NODEID+0x80000540|
| 0x02 | Transmission type     | UNSIGNED8  | rw  | no  | no   | 254           |
| 0x05 | Event timer           | UNSIGNED16 | rw  | no  | no   | 0             |
...
| 0x05 | Event timer           | UNSIGNED16 | rw  | no  | no   | 10            |
...
| 0x01 | Application object 1  | UNSIGNED32 | rw  | no  | no   | 0x20010120    |
| 0x02 | Application object 2  | UNSIGNED32 | rw  | no  | no   | 0x20010420    |
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Application object 4  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Application object 5  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Application object 6  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 2             |
| 0x01 | Application object 1  | UNSIGNED32 | rw  | no  | no   | 0x20010220    |
| 0x02 | Application object 2  | UNSIGNED32 | rw  | no  | no   | 0x20010520    |
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Application object 4  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Application object 5  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Application object 6  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 2             |
| 0x01 | Application object 1  | UNSIGNED32 | rw  | no  | no   | 0x20010320    |
| 0x02 | Application object 2  | UNSIGNED32 | rw  | no  | no   | 0x20010620    |
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Application object 4  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Application object 5  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Application object 6  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| 0x01 | Application object 1  | UNSIGNED32 | rw  | no  | no   | 0x20000020    |
| 0x02 | Application object 2  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Application object 4  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Application object 5  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x06          |
| 0x01 | accel_x               | UNSIGNED32 | ro  | t   | no   | 0             |
| 0x02 | accel_y               | UNSIGNED32 | ro  | t   | no   | 0             |
| 0x03 | accel_z               | UNSIGNED32 | ro  | t   | no   | 0             |
| 0x04 | gyro_x                | UNSIGNED32 | ro  | t   | no   | 0             |
| 0x05 | gyro_y                | UNSIGNED32 | ro  | t   | no   | 0             |
| 0x06 | gyro_z                | UNSIGNED32 | ro  | t   | no   | 0             |
