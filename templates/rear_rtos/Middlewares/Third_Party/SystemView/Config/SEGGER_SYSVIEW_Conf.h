...
// Tell SystemView we are using a Cortex-M core and an OS (FreeRTOS)
#define SEGGER_SYSVIEW_CORE               SEGGER_SYSVIEW_CORE_CM3
#define SEGGER_SYSVIEW_OS                 1

// Read directly from the Cortex-M7 DWT Cycle Counter hardware register
#define SEGGER_SYSVIEW_GET_TIMESTAMP()    (*(volatile unsigned int *)(0xE0001004))

// Pull the global clock speed variable
extern uint32_t SystemCoreClock;
#define SEGGER_SYSVIEW_TIMESTAMP_FREQ     SystemCoreClock

// Read directly from the Cortex-M7 ICSR register (IPSR bits)
