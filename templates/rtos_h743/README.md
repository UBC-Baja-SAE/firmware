# H743ZGT6 FreeRTOS v10.6 template
...
H743ZGT6 has 4 DMA controllers (varying types) with enough channels to allow all sensors to use DMA. For more 
information on the controllers go to the H743 product manual. DMA will allow sensor data to update directly to
